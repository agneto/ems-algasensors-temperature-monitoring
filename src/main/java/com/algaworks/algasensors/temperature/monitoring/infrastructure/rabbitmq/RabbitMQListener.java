...
public class RabbitMQListener {
    ...
    public void handleProcessingTemperature(@Payload final TemperatureLogData temperatureLogData,
                                            @Headers final Map<String, Object> headers) {
        log.info("Headers ::::: {}", headers);
        this.temperatureMonitoringService.processTemperatureReading(temperatureLogData);
    }
    ...
    public void handleAlerting(@Payload TemperatureLogData temperatureLogData) {
        ...
        this.sensorAlertService.handleAlert(temperatureLogData);
