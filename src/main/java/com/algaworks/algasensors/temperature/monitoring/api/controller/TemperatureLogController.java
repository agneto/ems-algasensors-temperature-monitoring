...
public class TemperatureLogController {
    ...
    @GetMapping
    public Page<TemperatureLogData> search(@PathVariable final TSID sensorId,
                                           @PageableDefault final Pageable pageable) {
        final Page<TemperatureLog> temperatureLogs = temperatureLogRepository.findAllBySensorId(
